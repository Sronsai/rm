...
/* @var $searchModel backend\models\ClearSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'สาเหตุที่ชัดเจน';
...
<div class="clear-index">
    ...
    <p>
        <?= Html::button('เพิ่มสาเหตุที่ชัดเจน', ['value' => Url::to('index.php?r=clear/create'), 'title' => 'เพิ่มสาเหตุที่ชัดแจ้ง', 'class' => 'btn btn-success', 'id' => 'activity-create-link']); ?>
    </p>
