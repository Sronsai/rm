    ...
    <center>
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading"><H2>ตัวชี้วัดโรงพยาบาล อัตราความเสี่ยงที่ได้รับการจัดการ ปีงบ 2560</H2></div>
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        <li role="presentation"><a href="?r=indications/index2558"><H3>ปีงบ 2558</H3></a></li>
                        <li role="presentation"><a href="?r=indications/index"><H3>ปีงบ 2559</H3></a></li>
                        <li role="presentation" class="active"><a href="?r=indications/index2560"><H3>ปีงบ 2560</H3></a></li>
                    </ul>
                    <br />
                    <?=
                    /* GridView::widget([
