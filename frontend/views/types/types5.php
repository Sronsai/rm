...
$this->title = 'รายการความเสี่ยงแยกตามประเภทเครื่องมือและอุปกรณ์การแพทย์';

$this->params['breadcrumbs'][] = ['label' => 'รายการความเสี่ยงทั้งหมด', 'url' => ['/report/report']];
$this->params['breadcrumbs'][] = 'รายการความเสี่ยงแยกตามประเภทเครื่องมือและอุปกรณ์การแพทย์';
?>



<div class="safe">
    <center><h1>รายการความเสี่ยงแยกตามประเภทเครื่องมือและอุปกรณ์การแพทย์</h1></center>
...
//echo \kartik\grid\GridView::widget([
                ...
                $type11 = Yii::$app->db->createCommand("SELECT count(r.status_id) as total from risk r where r.status_id ='1' and type_id = '5'")->queryScalar();
                $type12 = Yii::$app->db->createCommand("SELECT count(r.status_id) as total from risk r where r.status_id ='2' and type_id = '5'")->queryScalar();
