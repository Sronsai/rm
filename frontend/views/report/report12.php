...
$this->title = 'รายงานความเสี่ยงระดับ G H I';

$this->params['breadcrumbs'][] = ['label' => 'รายงานความเสี่ยงระดับ G H I', 'url' => ['/report/report12']];
$this->params['breadcrumbs'][] = 'รายงานความเสี่ยงระดับ G H I';
?>


<div class="report">
    <center><h1><u>รายงานความเสี่ยงระดับ G H I </u></h1></center>
    ...
    <div class="well">
        ...
        <form method="POST">  
            ...
            <div id="div6">
                <?php
                $list = yii\helpers\ArrayHelper::map(frontend\models\TypeClinic::find()->all(), 'id', 'clinic_name');
                echo yii\helpers\Html::dropDownList('clinic', $clinic, $list, [
                    'prompt' => 'เลือกประเภทคลินิก',
                    'class' => 'form-control',
                ]);
                ?>
            </div>&nbsp;
