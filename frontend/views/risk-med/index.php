...
/* $this->title = 'Risk Meds';
  $this->params['breadcrumbs'][] = $this->title; */
?>
<div class="risk-med-index">

    <div class="panel panel-primary">
        <div class="panel-heading"><center><H3><?= Html::img('./../images/mana.jpg'); ?>&nbsp;&nbsp;จัดการความเสี่ยง (ยา)</H3></center></div>
            ...
            if ($model->level_id == '9') {
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => 'typeMed.type_name',
                        'options' => ['width' => '80'],
                        'contentOptions' => ['class' => 'text-center'],
                        'headerOptions' => ['class' => 'text-center'],
                        'filter' => Html::activeDropDownList($searchModel, 'type_med_id', ArrayHelper::map(frontend\models\TypeMed::find()->asArray()->all(), 'id', 'type_name'), [
                            'class' => 'form-control', 'prompt' => ''
                        ]),
                    ],
                    //'sub_type_id',
