        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= 'วันที่ ' . Yii::$app->thaiFormatter->asDate($model->risk_date, 'long') .' เวลา '. Yii::$app->thaiFormatter->asTime($model->risk_date, 'medium') . ' น.'; ?></td>
                </tr>
                <tr>
                    <td>วันที่รายงาน/เวลา :</td>
                    <td><?= 'วันที่ ' . Yii::$app->thaiFormatter->asDate($model->risk_report, 'long') .' เวลา '. Yii::$app->thaiFormatter->asTime($model->risk_report,'medium') . ' น.'; ?></td>
                </tr>
                <tr>
                    <td>สรุปเหตุการณ์ :</td>
                ...
                <tr>
                    <td>ประเภท :</td>
                    <td><?= $model->typeMed->type_name; ?></td>
                </tr>
                <tr>
                    <td>ประเภทย่อย :</td>
                    <td><?= $model->subMedType->sub_med_type_name; ?></td>
                </tr>
                <tr>
                    <td>ระดับ :</td>
