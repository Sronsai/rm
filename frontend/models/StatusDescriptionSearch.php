...
/**
 * StatusDescriptionSearch represents the model behind the search form about `frontend\models\StatusDescription`.
 */
class StatusDescriptionSearch extends StatusDescription
{
    ...
    {
        return [
            [['id', 'status_active_id', 'status_id'], 'integer'],
            [['status_date', 'status_description', 'status_name'], 'safe'],
        ];
    }
