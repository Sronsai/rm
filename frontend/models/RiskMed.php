...
class RiskMed extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        [['person_id', 'location_riks_id', 'location_report_id', 'location_connection_id', 'type_med_id', 'sub_med_type_id', 'level_id', 'clear_id', 'system_id', 'status_id', 'type_clinic_id'], 'integer'],
